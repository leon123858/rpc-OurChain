...
A [TypeScript](https://www.typescriptlang.org) library to make RPC and HTTP REST requests to [OurChain](https://bitbucket.org/lab408/ourchain-release).

This project is base on [rpc-bitcoin](https://github.com/vansergen/rpc-bitcoin)
